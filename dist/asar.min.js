/*! `asar` grammar compiled for Highlight.js 11.4.0 */
(()=>{var a=(()=>{"use strict";return a=>({name:"65c816 Assembly (Asar)",
...
end:"\\s",relevance:5},a.COMMENT(";(?!s*$)","$"),{className:"string",begin:'"',
end:'"',relevance:0},{className:"number",variants:[{begin:"#?-?\\$[0-9a-f]+"},{
begin:"#?-?%[01]+"},{begin:"\\b-?\\d+"}],relevance:0},{className:"symbol",
variants:[{begin:"[a-z_][a-z0-9_]*:"},{begin:"![a-z0-9_]+"},{
begin:"%[a-z_][a-z0-9_]*"},{begin:"<[a-z_][a-z0-9_]*>"}]}],illegal:"/"})})()
;hljs.registerLanguage("asar",a)})();